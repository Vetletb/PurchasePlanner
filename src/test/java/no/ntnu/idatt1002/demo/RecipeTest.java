...
public class RecipeTest {
  ...
  class NegativeRecipeTest {
    ...
    void testGetAttributesNegative() {
      List<String> expectedAttributes = Arrays.asList("sushi", "20", "Japanese");
      assertNotEquals(expectedAttributes, recipe.getAttributes());
    }
     ...
     */
    @Test
    void testGetAttributeNamesNegative() {
      List<String> expectedAttributeNames = Arrays.asList("id", "name", "category");
      assertNotEquals(expectedAttributeNames, recipe.getAttributeNames());
    }

    /**
     * This method tests the getId method in the Recipe class. The result is expected to be false.
     */
    @Test
    void testGetIdNegative() {
      int expectedId = 2;
      assertNotEquals(expectedId, recipe.getId());
    }
    ...
    void testGetIdNameNegative() {
      String expectedIdName = "id";
      assertNotEquals(expectedIdName, recipe.getIdName());
    }
    ...
    void testGetRecipe_idNegative() {
      int expectedRecipe_id = 2;
      assertNotEquals(expectedRecipe_id, recipe.getRecipe_id());
    }

    /**
     * This method tests the getName method in the Recipe class. The result is expected to be false.
     */
    @Test
    void testGetNameNegative() {
      String expectedName = "sushi";
      assertNotEquals(expectedName, recipe.getName());
    }

    /**
     * This method tests the getCategory method in the Recipe class. The result is expected to be false.
     */
    @Test
    void testGetCategoryNegative() {
      String expectedCategory = "Japanese";
      assertNotEquals(expectedCategory, recipe.getCategory());
    }

    /**
     * This method tests the getCooking_time method in the Recipe class. The result is expected to be false.
     */
    @Test
    void testGetCooking_timeNegative() {
      int expectedCooking_time = 20;
      assertNotEquals(expectedCooking_time, recipe.getCooking_time());
    }

    /**
     * This method tests the toString method in the Recipe class. The result is expected to be false.
     */
    @Test
    void testToStringNegative() {
      String expectedString = "Recipe ID: 2, Name: sushi, Category: Japanese, Cooking Time: 20";
      assertNotEquals(expectedString, recipe.toString());
    }
  }
}
