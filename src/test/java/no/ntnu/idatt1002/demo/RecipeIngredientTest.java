...
public class RecipeIngredientTest {
  ...
  class PositiveRecipeIngredientTest {
    ...
    /**
     * This method tests the getAttributes method in the RecipeIngredient class. The result is expected to be true.
     */
      @Test
      ...
      /**
       * This method tests the getAttributeNames method in the RecipeIngredient class. The result is expected to be true.
       */
      @Test
      void testGetAttributeNamesPositive() {
        List<String> expectedAttributeNames = Arrays.asList("item_id", "quantity", "unit", "recipe_id");
        assertEquals(expectedAttributeNames, recipeIngredient.getAttributeNames());
      }

      /**
       * This method tests the getId method in the RecipeIngredient class. The result is expected to be true.
       */
      @Test
      ...
      /**
       * This method tests the getIdName method in the RecipeIngredient class. The result is expected to be true.
       */
      @Test
