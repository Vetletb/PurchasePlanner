...
public class InventoryItem extends ShoppingListItem{
   ...
   */
  public InventoryItem(int item_id, String name, String category, String allergy, int quantity, String unit, int expirationDate) {
   ...
   * @param expirationDate the expiration date of the item
   */
  public InventoryItem(int inventory_id, int item_id, String name, String category, String allergy, int quantity, String unit, int expirationDate) {
